        ...
        >
          <View style={styles.container}>
            ...
            <View style={styles.headerContainer}>
              <Text style={styles.headerTitle}>Butterfly Test</Text>
              <Text style={styles.tagline}>
              Take the Butterfly Click Test and choose a time range from 1 to 100 seconds. Perfect your butterfly clicking and maximize your CPS!
              </Text>
            </View>
